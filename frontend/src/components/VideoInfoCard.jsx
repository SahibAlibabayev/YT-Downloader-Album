...
// ── Helper: convert a byte count to a human-readable size string ────────────
...
// ── Helper: estimate MP3 file size from duration + bitrate (bytes) ──────────
...
export default function VideoInfoCard({
  ...
  // Crop to a square using canvas: centred region written to a 1000x1000 JPEG
  const handleCoverChange = (e) => {
    ...
    reader.onload = (ev) => {
      ...
      img.onload = () => {
        ...
        // Centred square crop (industry-standard 1:1 album art)
    ...
    <div className="glass-card rounded-2xl mb-8 relative overflow-hidden animate-[fadeInUp_0.6s_ease-out_forwards]">
      ...
      <div className="p-4 sm:p-6 lg:p-10">
        ...
        <div className="flex flex-col sm:flex-row gap-5 items-center sm:items-start mb-6">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="w-36 sm:w-44 flex-shrink-0 rounded-xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.5)] relative group">
              {/* Show custom thumbnail if set, otherwise fall back to the YouTube thumbnail */}
            ...
            {/* Hint about cover size — shown in album / playlist mode only */}
        ...
        {videoInfo.type === 'playlist' && (() => {
          // Calculate total size for selected tracks
        ...
        <div className="border-t border-[var(--border-subtle)] pt-5 mt-2">
          ...
          {/* Quality Buttons — always side-by-side */}
          ...
          {/* —— Metadata Section —— shown only in single and album mode */}
